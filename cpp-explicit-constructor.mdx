...
As a general practice, do not define implicit conversions. Use the `explicit` keyword for conversion operators and single-argument constructors (ref: Google C++ Style Guide).