...
As a general practice, do not define implicit conversions; use the `explicit` keyword for conversion operators and single-argument constructors, except in rare cases, such as for types meant to be interchangeable (ref: [Implicit Conversions, Google C++ Style Guide](https://google.github.io/styleguide/cppguide.html#Implicit_Conversions)).