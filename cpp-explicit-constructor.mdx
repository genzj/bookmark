...
Now the caller has to take one of the following approach to call `fill_something` with a `RGBA` instance. They are all _explict_ conversions and reminding the caller about alpha channel dropping.
