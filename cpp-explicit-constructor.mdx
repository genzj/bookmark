...
The `explicit` specifier can be used to make sure that the compiler doesn't take our constructor into implict conversions. After adding it to `RGB`'s constructor, 