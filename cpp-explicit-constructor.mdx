...
As a general practice, do not define implicit conversions by always using the `explicit` keyword for conversion operators and single-argument constructors (ref: [Implicit Conversions, Google C++ Style Guide](https://google.github.io/styleguide/cppguide.html#Implicit_Conversions)).